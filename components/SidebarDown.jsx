...
export default function SidebarDown({ onFilterApply }) {
  ...
  const handleFiltrar = () => {
    if (isFormValid()) {
      const appliedFilters = {
        ...
        all: incluirQuestionario ? "sim" : "não",
      };
  ...
  return (
    <div className="sidebar">
      ...
      < CheckBox 
      label={'Deseja ver os valores do questionário do estudante?'}
      checked={incluirQuestionario}
      onChange={setIncluirQuestionario}
      />
      <ButtonFilter
